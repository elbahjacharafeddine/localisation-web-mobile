...
public class ListDemandeurInvit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_demandeur_invit);
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if ("invitation".equals(item.getTitle())) {
                    ...
                    Intent intent = new Intent(ListDemandeurInvit.this,ListAmi.class);
    ...
    public void signUserOut(){
        ...
        Intent goToHome = new Intent(ListDemandeurInvit.this, SignInActivity.class);
    ...
    private void loadUser() {
        ...
        userApi.getDemandeurs(Integer.parseInt(id_aut.getText().toString()))
    ...
    private void populateListeView(List<User> listUser,int id_auth) {
        DemandeurAdapter userAdapter = new DemandeurAdapter(listUser,id_auth);
