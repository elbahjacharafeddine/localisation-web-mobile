...
public class SignUpActivity extends AppCompatActivity {
    ...
    EditText first_name, last_name, email, password, confirm,phone;
    Button sign_up_btn;
    ...
    public void processFormFields(){
        ...
        // The URL Posting TO:
        String url = "http://192.168.0.104:8080/api/v1/user/register";
