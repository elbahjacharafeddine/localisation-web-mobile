...
public class UserService {
    ...
    public int registerNewUserServiceMethod(String fname, String lname, String email, String password,String bdate,String genre,String phone){
        return userRepository.registerNewUser(fname,lname,email,password,bdate,genre,phone);
    }
    public int registerNewAmiServiceMethod(String fname, String lname, String email, String password){
        return userRepository.registerNewAmi(fname,lname,email,password);
    }
